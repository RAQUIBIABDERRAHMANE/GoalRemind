      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="space-y-4">
          ...
          <div className="text-xs text-gray-500 bg-gray-50 p-2 rounded">
            État : {isInstalled ? '✓ Installé' : '○ Non installé'} | 
            Prompt : {deferredPrompt ? '✓ Disponible' : '✗ Non disponible'}
          </div>
          ...
          {isInstalled ? (
            ...
            <>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h3 className="font-medium text-blue-900 mb-2">Comment installer manuellement :</h3>
                <ul className="list-disc list-inside text-sm text-blue-800 space-y-1">
                  <li><strong>Chrome/Edge (Desktop)</strong> : Cliquez sur l'icône ⊕ dans la barre d'adresse (à droite)</li>
                  <li><strong>Chrome (Android)</strong> : Menu (⋮) → Installer l'application</li>
                  <li><strong>Safari (iOS)</strong> : Partager → Ajouter à l'écran d'accueil</li>
                  <li><strong>Firefox (Android)</strong> : Menu → Installer</li>
                </ul>
                <div className="text-xs text-blue-700 mt-3 pt-3 border-t border-blue-200">
                  <p className="font-medium mb-1">💡 Pourquoi le bouton n'est pas disponible ?</p>
                  <ul className="list-disc list-inside space-y-1">
                    <li>L'app doit être sur HTTPS (OK en production, localhost OK aussi)</li>
                    <li>Le navigateur décide quand proposer l'installation</li>
                    <li>Visitez l'app plusieurs fois pour que Chrome propose l'installation</li>
                    <li>En attendant, utilisez l'installation manuelle ci-dessus ☝️</li>
                  </ul>
                </div>
              </div>
            </>
